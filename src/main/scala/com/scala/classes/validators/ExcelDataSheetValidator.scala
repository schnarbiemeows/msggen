  ...
  def validateDataQualifiers():Boolean = {
    ...
    for(i <- 0 until dataTypes.length){
      ...
      dataType match {
        ...
        case "EnumInt" => resultOfValidator = WholeNumberQualifiersValidator.validateEnumWholeNumberQualifiers(dataType,format,qualifiers)
        ...
        case "ExternalInt" => resultOfValidator = WholeNumberQualifiersValidator.validateExternalWholeNumberQualifiers(dataType,format,qualifiers)
        case "EnumLong" => resultOfValidator = WholeNumberQualifiersValidator.validateEnumWholeNumberQualifiers(dataType,format,qualifiers)
        ...
        case "ExternalLong" => resultOfValidator = WholeNumberQualifiersValidator.validateExternalWholeNumberQualifiers(dataType,format,qualifiers)
        case "EnumFloat" => resultOfValidator = DecimalNumberQualifiersValidator.validateEnumDecimalNumberQualifiers(dataType,format,qualifiers)
        ...
        case "ExternalFloat" => resultOfValidator = DecimalNumberQualifiersValidator.validateExternalDecimalNumberQualifiers(dataType,format,qualifiers)
        case "EnumDouble" => resultOfValidator = DecimalNumberQualifiersValidator.validateEnumDecimalNumberQualifiers(dataType,format,qualifiers)
        ...
        case "ExternalDouble" => resultOfValidator = DecimalNumberQualifiersValidator.validateExternalDecimalNumberQualifiers(dataType,format,qualifiers)
