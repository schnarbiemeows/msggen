...
object DoubleTypeGenerator {
  ...
  /**
    ...
    * @return - string
    */
  def makeEnumDouble(qualifiers:ArrayBuffer[String]):String = {
  ...
  /**
    ...
    * @return - string
    */
  def makeRandomDouble(format: String,qualifiers:ArrayBuffer[String]):String = {
  ...
  /**
    ...
    * @return - string
    */
  def makeExternalDouble(qualifiers:ArrayBuffer[String]):String = {
    var arrayLength = qualifiers.length
    var index = randomInteger(0,arrayLength)
    qualifiers(index)
  }
  ...
  /**
    * this method generates a random RangedDouble
    * @param format - formatting specifications for the field
    * @param qualifiers - array of possible values
    * @return - string
    */
  def makeRangedDouble(format: String,qualifiers:ArrayBuffer[String]):String = {
    var signDigits:Int = 0
    var length:Int = 0
    var min:Double = 0
    var max:Double = 0
    var roundingType:String = null
    val splitLists:Tuple2[Array[String],Array[String]] = filterQualifiers("RangedDouble", format)
    val formatsThatNeedQualifierChecks:Array[String] = splitLists._1
    val formatsNotNeedingQualifiers = splitLists._2
    for (i <- 0 until formatsThatNeedQualifierChecks.length) {
      formatsThatNeedQualifierChecks(i) match {
